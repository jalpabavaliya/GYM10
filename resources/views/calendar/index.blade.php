...
<body>
        ...
        <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
                <a class="navbar-brand brand-logo mr-5" href="{{ route('home') }}"><img
                        src="{{ asset('images/fitnesslogo.png') }}" class="mr-2" alt="logo"></a>
                <a class="navbar-brand brand-logo-mini" href="{{ route('home') }}"><img
                        src="{{ asset('images/fitnesslogo.png') }}" alt="logo"></a>
            </div>
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <div id="right-sidebar" class="settings-panel">
                ...
                <div class="tab-content" id="setting-content">
                    ...
                    <div class="tab-pane fade show active scroll-wrapper ps ps--active-y" id="chats-section"
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="ui-basic1">
                            <ul class="nav flex-column sub-menu"><b>FITNESS</b>
                                ...
                                @endcan
                                @can('workout-list')
                                    <li class="nav-item"> <a class="nav-link" href="{{ url('workouts') }}">Workouts</a>
                                    </li>
                                @endcan
                            </ul>
                            <ul class="nav flex-column sub-menu"><b>NUTRITION</b>
                                @can('meal-category-list')
                                    <li class="nav-item"> <a class="nav-link" href="{{ url('meal-category') }}">Meals
                                            Categories</a></li>
                                @endcan
                                @can('meal-list')
            ...
            <div class="main-panel">
                <div class="content-wrapper" style="padding: 0.0rem 2.375rem !important;">
                    <div class="container">
                        <div id='calendar'></div>
                    </div>
                </div>
    ...
    <link rel="stylesheet" href="{{ asset('css/vertical-layout-light/fullcalendar.css') }}">
    <link rel="stylesheet" href="{{ asset('css/vertical-layout-light/toastr.min.css') }}">

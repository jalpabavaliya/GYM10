                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select name="workout_type" class="form-group form-control" selected required>
                                            <option value="">Please Select Workout Type</option>
                                            <option value="1" {{ $workouts->workout_type == 1 ? 'selected' : '' }}>
                                                Regular</option>
                                            <option value="2" {{ $workouts->workout_type == 2 ? 'selected' : '' }}>
                                                Circuit</option>
                                            <option value="3" {{ $workouts->workout_type == 3 ? 'selected' : '' }}>
                                                Interval</option>
                                            <option value="4" {{ $workouts->workout_type == 4 ? 'selected' : '' }}>
                                                Video</option>
                                        </select>
                                    </div>
                                </div>
                                        ...
                                        @foreach ($exercises as $exercise)
                                            <div class="col-4">
                                                <label><input class="text-break" type="checkbox" name="exercise[]"
                                                        {{ in_array($exercise->id, $workouts->total_exercise) ? 'checked' : '' }}
                                ...
                                <div class="col-xs-6 col-sm-3 col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="estimate_time" value="{{ $workouts->est_time }}"
                                            class="form-group form-control">

...
@section('content')
    <div class="content-wrapper">
        <div class="row">
            <div class="col-lg-12 margin-tb">
                <div class="modal fade" id="assignmealmodal" tabindex="-1" role="dialog"
                    ...
                    <div class="modal-dialog modal-md" role="document">
                        <div class="modal-content">
                            ...
                            {!! Form::open(['route' => 'assignMeal.store', 'method' => 'POST']) !!}
    ...
    <script type="text/javascript">
        ...
        $('body').on('click', '.editassignmeal', function() {
            var meal_id = $(this).data('id');

            $.get("{{ url('assignMeal') }}" + '/' + 'edit/' + meal_id, function(
                data) {

            ...
            return Datatables::of($data)
                ...
                ->addColumn('action', function ($row) {
                    ...
                    if (Auth::user()->can('food-edit')) {
                        ...
                        $action = '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript:void(0)" data-toggle="tooltip" class="editfood" data-id="' . $row->id . '"><i class="fa fa-pencil p-2 rounded border"></i></a>';
                    }
                    if (Auth::user()->can('food-delete')) {
                        $action .= '&nbsp;&nbsp;&nbsp;<a href="' . route("food.destroy", $row->id) . '"><i class="fa fa-trash p-2 rounded border"></i></a>';
                    }
                    return $action;
                })
                ->rawColumns(['action'])
